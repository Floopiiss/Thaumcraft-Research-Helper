      ...
      return (
        e === this.firstNode
          ? ((this.firstNode = this.firstNode.next),
            e === this.lastNode && (this.lastNode = null))
          : (e === this.lastNode && (this.lastNode = d),
            (d.next = e.next),
            (e.next = null)),
        this.nElements--,
        !0
...
buckets.LinkedList.prototype.equals = function (a, b) {
  var c = b || buckets.defaultEquals;
  return !(a instanceof buckets.LinkedList) || this.size() !== a.size()
    ? !1
    : this.equalsAux(this.firstNode, a.firstNode, c);
};
  ...
  if (!(0 > a || a >= this.nElements)) {
    ...
    1 === this.nElements
      ...
      : ((a = this.nodeAtIndex(a - 1)),
        null === a
          ? ((b = this.firstNode.element),
            (this.firstNode = this.firstNode.next))
          : a.next === this.lastNode &&
            ((b = this.lastNode.element), (this.lastNode = a)),
...
buckets.LinkedList.prototype.reverse = function () {
  for (var a = null, b = this.firstNode, c = null; null !== b; )
...
buckets.LinkedList.prototype.toArray = function () {
  for (var a = [], b = this.firstNode; null !== b; )
    (a.push(b.element), (b = b.next));
  return a;
};
...
buckets.Dictionary.prototype.remove = function (a) {
  ...
  if (!buckets.isUndefined(b))
    return (delete this.table[a], this.nElements--, b.value);
};
buckets.Dictionary.prototype.keys = function () {
  var a = [],
    b;
  for (b in this.table)
    this.table.hasOwnProperty(b) && a.push(this.table[b].key);
  return a;
};
buckets.Dictionary.prototype.values = function () {
  var a = [],
    b;
  for (b in this.table)
    this.table.hasOwnProperty(b) && a.push(this.table[b].value);
  return a;
};
...
buckets.MultiDictionary.prototype.remove = function (a, b) {
  ...
  c = this.parent.get(a);
  return buckets.arrays.remove(c, b, this.equalsF)
    ? (0 === c.length && this.parent.remove(a), !0)
    : !1;
};
...
buckets.MultiDictionary.prototype.values = function () {
  for (var a = this.parent.values(), b = [], c = 0; c < a.length; c++)
...
buckets.Heap.prototype.minIndex = function (a, b) {
  return b >= this.data.length
    ? a >= this.data.length
      ? -1
      : a
    : 0 >= this.compare(this.data[a], this.data[b])
      ? a
      : b;
};
buckets.Heap.prototype.siftUp = function (a) {
  for (
    var b = this.parentIndex(a);
    0 < a && 0 < this.compare(this.data[b], this.data[a]);
  )
    (buckets.arrays.swap(this.data, b, a), (a = b), (b = this.parentIndex(a)));
};
buckets.Heap.prototype.siftDown = function (a) {
  for (
    var b = this.minIndex(this.leftChildIndex(a), this.rightChildIndex(a));
    0 <= b && 0 < this.compare(this.data[a], this.data[b]);
  )
    (buckets.arrays.swap(this.data, b, a),
      (a = b),
      (b = this.minIndex(this.leftChildIndex(a), this.rightChildIndex(a))));
};
buckets.Heap.prototype.peek = function () {
  if (0 < this.data.length) return this.data[0];
};
buckets.Heap.prototype.add = function (a) {
  if (!buckets.isUndefined(a))
    return (this.data.push(a), this.siftUp(this.data.length - 1), !0);
};
...
buckets.Bag.prototype.add = function (a, b) {
  ...
  this.contains(a)
    ? (this.dictionary.get(a).copies += b)
    : this.dictionary.set(a, { value: a, copies: b });
  this.nElements += b;
  return !0;
};
...
buckets.Bag.prototype.remove = function (a, b) {
  ...
  if (!(buckets.isUndefined(a) || 0 >= b) && this.contains(a)) {
    ...
    this.nElements =
      b > c.copies ? this.nElements - c.copies : this.nElements - b;
    c.copies -= b;
...
buckets.Bag.prototype.toArray = function () {
  for (
    var a = [], b = this.dictionary.values(), c = b.length, d = 0;
    d < c;
    d++
  )
...
buckets.Bag.prototype.toSet = function () {
  for (
    var a = new buckets.Set(this.toStrF),
      b = this.dictionary.values(),
      c = b.length,
      d = 0;
    d < c;
    d++
...
buckets.BSTree.prototype.add = function (a) {
  return buckets.isUndefined(a)
    ? !1
    : null !== this.insertNode(this.createNode(a))
      ? (this.nElements++, !0)
      : !1;
};
...
buckets.BSTree.prototype.searchNode = function (a, b) {
  for (var c = null; null !== a && 0 !== c; )
    ((c = this.compare(b, a.element)),
      0 > c ? (a = a.leftCh) : 0 < c && (a = a.rightCh));
  return a;
};
...
buckets.BSTree.prototype.inorderTraversalAux = function (a, b, c) {
  null === a ||
    c.stop ||
    (this.inorderTraversalAux(a.leftCh, b, c),
    c.stop ||
      ((c.stop = !1 === b(a.element)),
      c.stop || this.inorderTraversalAux(a.rightCh, b, c)));
};
...
buckets.BSTree.prototype.preorderTraversalAux = function (a, b, c) {
  null === a ||
    ...
    ((c.stop = !1 === b(a.element)),
    c.stop ||
      (this.preorderTraversalAux(a.leftCh, b, c),
      c.stop || this.preorderTraversalAux(a.rightCh, b, c)));
};
buckets.BSTree.prototype.postorderTraversalAux = function (a, b, c) {
  null === a ||
    c.stop ||
    (this.postorderTraversalAux(a.leftCh, b, c),
    c.stop ||
      (this.postorderTraversalAux(a.rightCh, b, c),
      c.stop || (c.stop = !1 === b(a.element))));
};
...
buckets.BSTree.prototype.successorNode = function (a) {
  ...
  for (var b = a.parent; null !== b && a === b.rightCh; )
    ((a = b), (b = a.parent));
  return b;
};
buckets.BSTree.prototype.heightAux = function (a) {
  return null === a
    ? -1
    : Math.max(this.heightAux(a.leftCh), this.heightAux(a.rightCh)) + 1;
};
buckets.BSTree.prototype.insertNode = function (a) {
  ...
  null === b
    ? (this.root = a)
    : 0 > this.compare(a.element, b.element)
      ? (b.leftCh = a)
      : (b.rightCh = a);
  return a;
};
